...
import { collection, addDoc, setDoc, doc, docs, getDocs, getDoc, updateDoc } from "firebase/firestore";
...
function UserLogin() {
    ...
    const contentview = router.query.view;
    console.log("login previous", vid);
    console.log("login previous", contentview);
     ...
     const SubmitLogData = async (e) => {
        ...
        if (!username) {
            ...
            if (data === undefined) {
                ...
                // HandlePoupDewdrop(data);
                // Router.push("/dewdrops?vid=" + vid);
                router.push(`/dewdrops?vid=${vid}&view=${contentview}`, undefined, { shallow: true })
    ...
    <>
     {loginStatus? null :<section className='loadingScreen'>
        ...
        <section className="c-login">
            {/* <div className='loginbg'> */}
                {/* <Image src={loginbg}  alt='applogo'  layout='responsive' /> */}
            {/* </div> */}
         ...
         {sendOtp ?   <div className='loginInput'>
                    ...
                    <li className={mobilenumerror ? 'error':null }>
                        ...
                        <li>
                            <button type="submit" disabled={verifynumber} onClick={handleSendOtp}>{verifynumber ? "Verify Number...":"GET OTP"}</button>
                        </li>
                    </ul>
                ...
                {verifyName ? <div className='loginInput'>
                    <ul>
                        ...
                        <li>
                            <button type="submit" disabled={verifynumber} onClick={() => SubmitLogData()}>{verifynumber ? "Redirect Home..." : "LOGIN"}</button>
                        </li>
